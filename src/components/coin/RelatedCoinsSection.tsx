      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 id="related-coins-heading" className="text-base sm:text-lg font-bold text-slate-900 dark:text-white tracking-tight flex items-center gap-2 font-sans">
            <Layers size={18} className="text-[#455c00] dark:text-[#daff41]" /> Related Cryptocurrencies
          </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {relatedList.map((coin) => (
          <div
            ...
            className="bg-slate-50 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800/50 hover:border-[#daff41]/50 rounded-xl p-4 transition-all cursor-pointer group shadow-xs hover:shadow-md"
          >
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2.5">
                ...
                />
                <div>
                  <h3 className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-[#455c00] dark:group-hover:text-[#daff41] transition-colors">
                    {coin.name}
                  </h3>
              ...
              <ArrowRight size={14} className="text-slate-400 group-hover:text-[#455c00] dark:group-hover:text-[#daff41] group-hover:translate-x-1 transition-transform" />
            </div>
