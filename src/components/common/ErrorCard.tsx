...
export const ErrorCard: React.FC<ErrorCardProps> = ({
  ...
  if (isDelayedNotice) {
    return (
      <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-3 flex items-center justify-between text-amber-300 text-xs mb-4">
        ...
        {onRetry && (
          <button
            onClick={onRetry}
            className="flex items-center gap-1 font-semibold hover:underline text-amber-200 cursor-pointer ml-2 shrink-0"
          >
  ...
  return (
    <div className="bg-[#161e2e] border border-rose-500/30 rounded-2xl p-6 text-center max-w-md mx-auto my-8">
