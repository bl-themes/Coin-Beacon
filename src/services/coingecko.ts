...
export async function fetchTopCoins(page = 1, perPage = 100): Promise<{ data: Coin[]; source: string; isDelayed?: boolean }> {
...
export async function fetchCoinChart(id: string, range: TimeRange = '7D'): Promise<{
